...
public class App {
    ...
    public static void main(String[] args) {
         ...
         * Player player4 = new IterativeDeepening(limit, closeMoves);
         * Player player5 = new IterativeDeepening_PVS(limit, closeMoves);
         * 
         * Player p1 = player4;
         * Player p2 = player4;
         * 
        ...
        System.out.printf("%s/%s/%s/%s/%s%n", gameData.get(0)[0].printResults(), gameData.get(1)[0].printResults(),
                gameData.get(2)[0].printResults(), gameData.get(3)[0].printResults(),
                gameData.get(4)[0].printResults());
        System.out.printf("%s%n%s%n%s%n%s%n%s%n", gameData.get(0)[1].printResults(), gameData.get(1)[1].printResults(),
